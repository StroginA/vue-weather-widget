...
(function(t, e) {
  (function(r, o) {
    ...
    return function(o) {
      ...
      "2d00": function(o, a, i) {
        var s = i("da84"), l = i("342f"), c = s.process, f = c && c.versions, u = f && f.v8, d, h;
        u ? (d = u.split("."), h = d[0] + d[1]) : l && (d = l.match(/Edge\/(\d+)/), (!d || d[1] >= 74) && (d = l.match(/Chrome\/(\d+)/), d && (h = d[1]))), o.exports = h && +h;
      },
      "342f": function(o, a, i) {
        var s = i("d066");
